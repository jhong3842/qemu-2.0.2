...
libs_softmmu=-lutil -lncurses -ltinfo  -lpng12 -ljpeg -lSDL -lX11  -lfdt -lpixman-1
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.0.2
PKGVERSION=
SRC_PATH=/home/jhong/qemu-2.0.2
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/jhong/qemu-2.0.2/bin/debug/native/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
LDFLAGS_NOPIE=
LIBTOOLFLAGS= -Wc,-fstack-protector-strong
LIBS+=-lrt -lgthread-2.0 -pthread -lglib-2.0  -lz
LIBS_TOOLS+=
EXESUF=
DSOSUF=.so
LDFLAGS_SHARED=-shared
LIBS_QGA+=-lrt -lgthread-2.0 -pthread -lglib-2.0 
